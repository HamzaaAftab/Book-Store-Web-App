  ...
  return (
    ...
    <div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div class="max-w-lg dark:bg-slate-900 dark:text-white">
                <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl dark:bg-slate-900 dark:text-white">About Us</h2>
                <p class="mt-4 text-gray-600 text-lg dark:bg-slate-900 dark:text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis
