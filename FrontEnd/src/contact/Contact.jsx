...
<div class="container mt-16 mx-auto md:px-6 min-h-screen dark:bg-slate-900 dark:text-white">
 
  <section class="mb-32 text-center dark:bg-slate-900 dark:text-white min-h-screen">
    <div class="py-12 md:px-12">
      <div class="container mx-auto xl:px-32">
        <div class="grid items-center lg:grid-cols-2">
          <div class="mb-12 md:mt-12 lg:mt-0 lg:mb-0 dark:bg-slate-900 dark:text-white">
            <div
